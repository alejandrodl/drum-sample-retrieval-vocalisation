...
for m in range(len(modes)):
    ...
    if mode=='unsupervised' or mode=='unsupervised_bark' or mode=='ae_99':
    ...
    for it in range(3):
        ...
        if mode=='unsupervised' or mode=='unsupervised_bark' or mode=='ae_99':
            ...
            x = layers.ReLU()(x)
            x = layers.Conv2D(filters=8, kernel_size=(9,9), strides=(1,1), activation=None, padding='same')(x)
            x = layers.BatchNormalization()(x)
            x = layers.ReLU()(x)
            x = layers.Conv2D(filters=8, kernel_size=(9,9), strides=(1,1), activation=None, padding='same')(x)
            x = layers.BatchNormalization()(x)
            ...
            x = layers.Conv2D(filters=16, kernel_size=(7,7), strides=(1,1), activation=None, padding='same')(x)
            x = layers.BatchNormalization()(x)
            x = layers.ReLU()(x)
            x = layers.Conv2D(filters=16, kernel_size=(7,7), strides=(1,1), activation=None, padding='same')(x)
            x = layers.BatchNormalization()(x)
            x = layers.ReLU()(x)
            x = layers.MaxPool2D(pool_size=(2, 2), padding='valid')(x)
            x = layers.Conv2D(filters=32, kernel_size=(5,5), strides=(1,1), activation=None, padding='same')(x)
            x = layers.BatchNormalization()(x)
            x = layers.ReLU()(x)
            x = layers.Conv2D(filters=32, kernel_size=(5,5), strides=(1,1), activation=None, padding='same')(x)
            x = layers.BatchNormalization()(x)
            ...
            dec = layers.BatchNormalization()(dec)
            dec = layers.ReLU()(dec)
            dec = layers.Conv2DTranspose(filters=1, kernel_size=9, strides=1, padding='same', activation=None)(dec)
            dec = layers.BatchNormalization()(dec)
            dec = layers.ReLU()(dec)
            ...
            checkpoint_path = "checkpoints_ae_99/cp_" + mode + "_" + str(it) + ".ckpt"
