...
np.save('data/interim/Dataset_VIM_Percussive', Spec_Matrix_All)
...
path_audio = 'data/external/Beatbox'
...
np.save('data/interim/Beatbox/Dataset_Beatbox', Spec_Matrix_All)
np.save('data/interim/Beatbox/Classes_Beatbox', np.array(Classes))
